...
#include "iv_light_volumetrics_ps20b.inc"
#include "iv_light_volumetrics_vs20.inc"

BEGIN_VS_SHADER( iv_light_volumetrics, "" )
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			// Vertex Shader
			DECLARE_STATIC_VERTEX_SHADER( iv_light_volumetrics_vs20 );
			SET_STATIC_VERTEX_SHADER( iv_light_volumetrics_vs20 );

			DECLARE_STATIC_PIXEL_SHADER( iv_light_volumetrics_ps20b );
			SET_STATIC_PIXEL_SHADER_COMBO( FLASHLIGHTDEPTHFILTERMODE, g_pHardwareConfig->GetShadowFilterMode() );
			SET_STATIC_PIXEL_SHADER( iv_light_volumetrics_ps20b );
		}
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( iv_light_volumetrics_vs20 );
			SET_DYNAMIC_VERTEX_SHADER( iv_light_volumetrics_vs20 );

			DECLARE_DYNAMIC_PIXEL_SHADER( iv_light_volumetrics_ps20b );
			SET_DYNAMIC_PIXEL_SHADER( iv_light_volumetrics_ps20b );
