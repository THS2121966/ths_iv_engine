...
IMPLEMENT_SERVERCLASS_ST(CIV_Dynamic_Light, DT_IV_Dynamic_Light)
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CIV_Dynamic_Light::KeyValue( const char *szKeyName, const char *szValue )
{
...
//------------------------------------------------------------------------------
void CIV_Dynamic_Light::InputTurnOn( inputdata_t &inputdata )
{
	m_Flags = m_ActualFlags;
	m_On = true;
}
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CIV_Dynamic_Light::InputTurnOff( inputdata_t &inputdata )
{
	// This basically shuts it off
	m_Flags = DLIGHT_NO_MODEL_ILLUMINATION | DLIGHT_NO_WORLD_ILLUMINATION;
	m_On = false;
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CIV_Dynamic_Light::InputToggle( inputdata_t &inputdata )
{
	if (m_On)
	{
...
// Purpose :
//------------------------------------------------------------------------------
void CIV_Dynamic_Light::Spawn( void )
{
	Precache();
	SetSolid( SOLID_NONE );
	m_On = true;
	...
	{
		SetThink( &CIV_Dynamic_Light::DynamicLightThink );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CIV_Dynamic_Light::DynamicLightThink( void )
{
	if ( m_target == NULL_STRING )
		return;
