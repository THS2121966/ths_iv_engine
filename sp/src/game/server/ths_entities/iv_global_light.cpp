...
//------------------------------------------------------------------------------
class CIVGlobalLight : public CBaseEntity
{
public:
	DECLARE_CLASS( CIVGlobalLight, CBaseEntity );
...
LINK_ENTITY_TO_CLASS(iv_global_light, CIVGlobalLight);
...
//------------------------------------------------------------------------------
int CIVGlobalLight::UpdateTransmitState()
{
...
bool CIVGlobalLight::KeyValue( const char *szKeyName, const char *szValue )
{
#ifdef MAPBASE
...
bool CIVGlobalLight::GetKeyValue( const char *szKeyName, char *szValue, int iMaxLen )
{
	if ( FStrEq( szKeyName, "color" ) )
	{
...
// Purpose :
//------------------------------------------------------------------------------
void CIVGlobalLight::Spawn( void )
{
	Precache();
	SetSolid( SOLID_NONE );
}
...
// Input values
//------------------------------------------------------------------------------
void CIVGlobalLight::InputSetAngles( inputdata_t &inputdata )
{
...
//------------------------------------------------------------------------------
void CIVGlobalLight::InputEnable( inputdata_t &inputdata )
{
	m_bEnabled = true;
}
...
void CIVGlobalLight::InputSetEnableShadows( inputdata_t &inputdata )
{
	m_bEnableShadows = inputdata.value.Bool();
}

void CIVGlobalLight::InputSetLightColor( inputdata_t &inputdata )
{
	m_LightColor = inputdata.value.Color32();
} 

#ifdef MAPBASE
void CIVGlobalLight::InputSetBrightness( inputdata_t &inputdata )
{
	m_flBrightnessScale = inputdata.value.Float();
}

void CIVGlobalLight::InputSetColorTransitionTime( inputdata_t &inputdata )
{
